...
$Services = @("control-api", "customer-simulator", "restaurant-worker", "courier-simulator", "order-worker", "cluster-observer", "migrate")
...
Write-Host "Images mit Tag $Tag wurden gebaut."
